...
public function askMessage(){
		$sendEmail=D('Mail');
		$sendMsg=D('Message');
		$sendContext='尊敬的实验室管理员：您好，九号教学楼9228教室，温湿度异常，请及时处理！';
		$sendMsg->SendMessage('15623053086', '环境监测系统报警信息通知', $sendContext);	
		$sendEmail->SendMail('15623053086@163.com',$sendContext);
	}
