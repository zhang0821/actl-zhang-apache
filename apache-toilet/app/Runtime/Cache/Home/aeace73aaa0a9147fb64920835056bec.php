...
<div id="sidebar">
  <ul>
	...
	<li class="active"><a href="CO2AndLight.html"><i class="icon icon-fire"></i> <span style="font-size:18px">CO2 & Light</span></a> </li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
		...
		<div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:green;font-size:18px">CO2 Concentration</h5>
          </div>
          <div class="widget-content">
		  <div id="CO2holder"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:blue;font-size:18px">Light Intensity</h5>
          </div>
          <div class="widget-content">
            <div id="lightholder"></div>
          </div>
        </div>
      </div>
    </div>
...
<script src="/HTTP-Zigbee/app/Public/js/CO2AndLight.js"></script> 
