...
<html lang="en">
<head>
<title>Elecrticity And Water</title>
<meta charset="UTF-8" />
...
<div id="sidebar">
  <ul>
	...
	<li class="active"><a href="ElectricityAndWater.html"><i class="icon icon-bolt"></i> <span style="font-size:18px">Elecrticity & Water</span></a> </li>
    ...
    <li><a href="Zigbee.html"><i class="icon icon-signal"></i> <span style="font-size:18px">Zigbee Topology</span></a></li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
		...
		<div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:green;font-size:18px">Elecrticity</h5>
          </div>
          <div class="widget-content">
		  <div id="elecrticityholder"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:blue;font-size:18px">Water</h5>
          </div>
          <div class="widget-content">
...
<script src="/HTTP-Zigbee/app/Public/js/ElectricityAndWater.js"></script> 
