...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-signal"></i> Charts &amp; graphs</a>
  <ul>
    <li class="active"> <a href="charts.html"><i class="icon icon-signal"></i> <span style="font-size:18px">Environment Info</span></a> </li>
    <li><a href="tables.html"><i class="icon icon-th"></i> <span style="font-size:18px">Zigbee Topology</span></a></li>
  </ul>
</div>
<div id="content">
...
<script src="/HTTP-Zigbee/app/Public/protected/js/jquery.flot.min.js"></script> 
<script src="/HTTP-Zigbee/app/Public/protected/js/matrix.charts.js"></script> 
<script src="/HTTP-Zigbee/app/Public/protected/js/matrix.js"></script> 
<script src="/HTTP-Zigbee/app/Public/js/monitor.js"></script> 
<script src="/HTTP-Zigbee/app/Public/protected/js/matrix.dashboard.js"></script>
</body>
</html>