...
<div id="sidebar">
  <ul>
    ...
    <li class="active"><a href="Zigbee.html"><i class="icon icon-signal"></i> <span style="font-size:18px">Zigbee & Location</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Zigbee Topology</a></div>
  </div>
    ...
    <div class="row-fluid">
      <div class="span12">
		...
		<div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:green;font-size:18px">Network Topology</h5>
          </div>
          <div class="widget-content"> 
		  <img id="zigbee" src="/HTTP-Zigbee/app/Public/images/zigbee-topology.png"></img>
          </div>
        </div>
      </div>
    </div>
   ...
   <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
		<div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:green;font-size:18px">Elderly Location</h5>
          </div>
          <div class="widget-content"> 
		  <img id="location" src="/HTTP-Zigbee/app/Public/images/location9222.png"></img>
          </div>
        </div>
      </div>
    </div>
...
<script src="/HTTP-Zigbee/app/Public/js/ZigbeeTopology.js"></script>
