...
<html lang="en">
<head>
<title>SkinTemperatue And HerartRate</title>
<meta charset="UTF-8" />
...
<div id="sidebar">
  <ul>
	...
	<li class="active"><a href="SkinAndHeart.html"><i class="icon icon-heart"></i> <span style="font-size:18px">SkinTemp & Heart</span></a> </li>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
		...
		<div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:green;font-size:18px">SkinTemperatue</h5>
          </div>
          <div class="widget-content">
		  <div id="skinTempholder"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5 style="color:blue;font-size:18px">HeartRate</h5>
          </div>
          <div class="widget-content">
            <div id="heartholder"></div>
          </div>
        </div>
      </div>
    </div>
...
<script src="/HTTP-Zigbee/app/Public/js/SkinAndHeart.js"></script> 
