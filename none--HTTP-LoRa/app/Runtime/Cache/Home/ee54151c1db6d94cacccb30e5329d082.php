...
<div id="sidebar">
  <ul>
    ...
    <li class="active"><a href="zigbee.html"><i class="icon icon-signal"></i> <span style="font-size:18px">Zigbee Topology</span></a></li>
...
<script src="/HTTP-Zigbee/app/Public/js/zigbee.js"></script>
