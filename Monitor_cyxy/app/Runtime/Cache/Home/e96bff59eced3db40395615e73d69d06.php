...
<div id="sidebar">
  <ul>
	...
	<li class="active"><a href="History.html"><i class="icon icon-th"></i> <span style="font-size:18px">History Data</span></a></li>
  </ul>
</div>
		  ...
		  <div class="span12">
			<div class="widget-box">
			  <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
				<h5 style="color:PaleVioletRed;font-size:20px">History Data</h5>
			  </div>
			  <div class="widget-content nopadding">
			    <table class="table table-bordered table-striped">
                  <thead>
					<tr>
					  <th style="color:Teal;font-size:20px">Weekday</th>
					  <th style="color:Teal;font-size:20px">HeartRate</th>
					  <th style="color:Teal;font-size:20px">WalkStep</th>
					  <th style="color:Teal;font-size:20px">SleepTime</th>
					  <th style="color:Teal;font-size:20px">Calories</th>
					  <th style="color:Teal;font-size:20px">SkinTemperature</th>
					</tr>
				  </thead>
...
<script src="/HTTP-Zigbee/app/Public/js/History.js"></script>
</body>
</html>