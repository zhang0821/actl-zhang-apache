...
<link rel="stylesheet" href="/Monitor_cyxy/app/Public/Monitor/css/showSys.css" type="text/css" />
<link rel="shortcut icon" href="/Monitor_cyxy/app/Public/Monitor/img/title.ico" type="image/x-icon" />

<!-- <script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/jquery-1.11.3.min.js"></script> -->

<script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/jquery.min.js"></script>
<!-- <script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/d3.min.js"></script> -->
<script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/highcharts.js"></script>     
<script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/func.js"></script>

<script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/curve.js"></script>
<script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/style.js"></script>
<script type="text/javascript" src="/Monitor_cyxy/app/Public/Monitor/js/showSysMain.js"></script>
...
<title>LoRa环境监测</title>
<NOSCRIPT><iframe src="/Monitor_cyxy/app/Home/View/Index/index.html"></iframe></NOSCRIPT>
</head>
<body>
	<div class="topBar">
		...
		<div class="title">
			...
			<div class="textBar" >
				...
				<audio src="/Monitor_cyxy/app/Public/Monitor/music/fire.mp3" controls="controls"  id="music"  loop="loop" hidden="hidden">
				</audio>
	...
	<div class="TemHumBox" >
		<div class="TemHumBoxMain">
			...
			<ul class="floorTabs" >
				...
				<li>
					<input type="radio" name="tabs" id="tab2" class="floorTab" onclick="tabClick(2)"/>
					<label for="tab2">二楼</label>
					<div id="tab-floor-2" class="tab-floor tem_hum_draw"  >	
						
					</div>
				</li>
				<li>
					<input type="radio" name="tabs" id="tab3" class="floorTab" onclick="tabClick(3)"/>
					<label for="tab3">三楼</label>
					<div id="tab-floor-3" class="tab-floor tem_hum_draw"  >	
						
					</div>
				</li>

				<li>
					<input type="radio" name="tabs" id="tab4" class="floorTab" onclick="tabClick(4)"/>
					<label for="tab4">四楼</label>
					<div id="tab-floor-4" class="tab-floor tem_hum_draw"  >	
						
					</div>
				</li>

				<li>
					<input type="radio" name="tabs" id="tab5" class="floorTab" onclick="tabClick(5)"/>
					<label for="tab5">五楼</label>
					<div id="tab-floor-5" class="tab-floor tem_hum_draw"  >	
						
					</div>
				</li>

				<li>
					<input type="radio" name="tabs" id="tab6" class="floorTab" onclick="tabClick(6)"/>
					<label for="tab6">六楼</label>
					<div id="tab-floor-6" class="tab-floor tem_hum_draw"  >	
						
					</div>

				</li>
				<li>
					<input type="radio" name="tabs" id="tab7" class="floorTab" onclick="tabClick(7)"/>
					<label for="tab7">驿站</label>
					<div id="tab-floor-7" class="tab-floor tem_hum_draw"  >	
						暂无信息
					</div>

				</li>
				<li>
					<input type="radio" name="tabs" id="tab8" class="floorTab" onclick="tabClick(8)"/>
					<label for="tab8">信息表</label>
