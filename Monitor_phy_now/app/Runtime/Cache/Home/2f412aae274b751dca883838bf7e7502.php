...
<link rel="stylesheet" href="/Monitor_phy_now/app/Public/Monitor/css/showSys.css" type="text/css" />
<link rel="shortcut icon" href="/Monitor_phy_now/app/Public/Monitor/img/title.ico" type="image/x-icon" />

<!-- <script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/jquery-1.11.3.min.js"></script> -->

<script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/jquery.min.js"></script>
<!-- <script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/d3.min.js"></script> -->
<script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/highcharts.js"></script>     
<script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/func.js"></script>

<script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/curve.js"></script>
<script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/style.js"></script>
<script type="text/javascript" src="/Monitor_phy_now/app/Public/Monitor/js/showSysMain.js"></script>
...
<NOSCRIPT><iframe src="/Monitor_phy_now/app/Home/View/Index/index.html"></iframe></NOSCRIPT>
</head>
<body>
	<div class="topBar">
		...
		<div class="title">
			...
			<div class="textBar" >
				...
				<audio src="/Monitor_phy_now/app/Public/Monitor/music/fire.mp3" controls="controls"  id="music"  loop="loop" hidden="hidden">
				</audio>
